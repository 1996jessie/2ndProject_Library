...
<style type="text/css">
    ...
    .books-table .button-cell {
        text-align: right;
    }
    .books-table .borrow-button {
        background-color: #4CAF50;
    }
    .books-table .reserve-button {
        background-color: #008CBA;
    }
    .books-table .button-cell a {
        color: white;
        padding: 10px 20px;
        text-decoration: none;
    ...
    .books-table .button-cell a:hover {
        opacity: 0.8;
    }
    ...
    .borrow-button:hover, .reserve-button:hover {
        background-color: #0056b3;
    }
</style>
...
<table class="category-table" border="1" align="left" style="margin-right: 10px;">
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=000">
                총류
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=100">
                철학
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=200">
                종교
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=300">
                사회과학
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=400">
                자연과학
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=500">
                기술과학
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=600">
                예술
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=700">
                언어
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=800">
                문학
            </a>
        </td>
    </tr>
    <tr>
        <td>
            <a href="searchBookByCategory.jsp?bcategory=900">
                역사
            </a>
        </td>
    </tr>
...
%>
            <tr align = "center">
                ...
                <td> <a href="../BorrowBook/borrowThisBook.jsp?bcode=<%= bb.getBcode() %>&mnum=<%= mnum %>&bnum=<%= bb.getBnum() %>" class="borrow-button">대출</a></td>
                <td><a href="../ReserveBook/reserveThisBook.jsp?bcode=<%= bb.getBcode() %>&mnum=<%= mnum %>&bnum=<%= bb.getBnum() %>" class="reserve-button">예약</a></td>
            </tr>
<%              }
        }
%>
