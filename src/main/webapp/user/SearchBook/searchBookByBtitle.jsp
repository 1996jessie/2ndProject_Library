...
<div class="search-form">
	...
	<%
		...
		String btitle2 = request.getParameter("btitle2");
		System.out.println("<searchBookByBtitle> btitle2 : " + btitle2);
		BookDao bdao = BookDao.getInstance();
		ArrayList<BookBean> blist = bdao.getBookContainsBtitle(btitle2);
			
		if(blist.size() > 0) {
	%>		 <table class="search-table" align="center">
				<tr >
					<td align = "center">요청하신 <strong>"<%= btitle2 %>"</strong> 에 대한 자료 검색 결과이며 총 <%= blist.size() %>개가 검색되었습니다.</td>
				</tr>
			</table>
	<% 		
